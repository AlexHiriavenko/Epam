...
describe("HTML Text elements", () => {
    ...
    describe("Lists", () => {
        describe("Prime crew list", () => {
            it.each([
                ...
                'ordered list item should have correct text: "%s"',
                (expectedText, index) => {
                    const personnelArticle =
                        document.querySelectorAll("body > article")[1];
                    const section =
                        personnelArticle.querySelectorAll("section")[0];
            ...
            it.each([
                ...
                (expectedText, index) => {
                    const personnelArticle =
                        document.querySelectorAll("body > article")[1];
                    const section =
                        personnelArticle.querySelectorAll("section")[1];
                    const listItems = section.querySelectorAll("ol > li");
                    const li = listItems[index];
        ...
        describe("Flight directors list", () => {
            it.each([
                ...
                'unordered list item should have correct text: "%s"',
                (expectedText, index) => {
                    const personnelArticle =
                        document.querySelectorAll("body > article")[1];
                    const section =
                        personnelArticle.querySelectorAll("section")[2];
        ...
        describe("Quote", () => {
            ...
            it("should have Kennedy's quote text inside", () => {
                ...
                expect(
                    p.textContent
                        .trim()
                        .startsWith("I believe that this nation")
                ).toBe(true);
            });
    ...
    describe("Emphasized, italic, superscript text", () => {
        ...
        it("should emphasize quote", () => {
            ...
            expect(em.textContent.trim()).toBe(
        ...
        describe("italic", () => {
            it.each([[0], [1], [2]])(
                "should have italized text chunk #%i with at list 3 symbols",
                (index) => {
